<template>
  <div ref="main_div">
    ...
    <b-row style="margin-top: 0" align-h="between">
      ...
      <b-col
        md="4"
        :style="{height: (this.main_div_height-70)+'px', overflow: 'auto', width: '33vw', 'text-align': 'center'}"
      >
    ...
    <b-modal
      ...
      size="xl"
      :title="this.clicked_basic_param_name+'-'+this.$store.state.blast_id2_zh[this.blast_selected]"
